...
from pip._internal.utils.misc import (dist_in_install_path, dist_in_usersite,
                                      ensure_dir, normalize_version_info)
...
class Resolver(object):
    ...
    def _set_req_to_reinstall(self, req):
        ...
        if (
            not self.use_user_site or dist_in_usersite(req.satisfied_by)
