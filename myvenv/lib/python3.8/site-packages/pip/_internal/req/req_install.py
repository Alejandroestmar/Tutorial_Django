...
from pip._internal.utils.misc import (_make_build_dir, ask_path_exists,
                                      backup_dir, display_path,
                                      dist_in_install_path,
                                      dist_in_site_packages, dist_in_usersite,
                                      ensure_dir, get_installed_version,
                                      hide_url, redact_auth_from_url, rmtree)
...
class InstallRequirement(object):
    ...
    def move_to_correct_build_directory(self):
        ...
        assert (
            self._ideal_build_dir is not None
    ...
    def install_editable(
        ...
        with indent_log():
            with self.build_env:
                call_subprocess(
                    base_cmd + ["develop", "--no-deps"] + list(install_options),
