...
from pip._internal.exceptions import (InstallationError, InvalidWheelFilename,
                                      UnsupportedWheel)
...
from pip._internal.utils.subprocess import (LOG_DIVIDER, call_subprocess,
                                            format_command_args,
...
if MYPY_CHECK_RUNNING:
    from typing import (IO, Any, Callable, Dict, Iterable, List, Mapping,
                        Optional, Sequence, Set, Text, Tuple)
...
class WheelBuilder(object):
    ...
    def _build_one_pep517(self, req, tempd, python_tag=None):
        ...
        try:
            ...
            if python_tag:
                ...
                os.rename(
                    os.path.join(tempd, wheel_name), os.path.join(tempd, new_name)
                )
    ...
    def build(
        ...
        assert (should_unpack and not self._wheel_dir) or (
            ...
            for req, output_dir in buildset:
                ...
                if wheel_file:
                    ...
                    if should_unpack:
                        ...
                        if req.source_dir and not has_delete_marker_file(
                            req.source_dir
                        ):
