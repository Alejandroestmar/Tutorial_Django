...
def match(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, ignore_unused, kwargs).match(
...
def fullmatch(
    ...
    **kwargs
    ...
    object, or None if no match was found."""
    return _compile(pattern, flags, ignore_unused, kwargs).fullmatch(
        string, pos, endpos, concurrent, partial, timeout
    )
...
def search(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, ignore_unused, kwargs).search(
        string, pos, endpos, concurrent, partial, timeout
    )
...
def sub(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, ignore_unused, kwargs).sub(
        repl, string, count, pos, endpos, concurrent, timeout
    )
...
def subf(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, ignore_unused, kwargs).subf(
...
def subn(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, ignore_unused, kwargs).subn(
        repl, string, count, pos, endpos, concurrent, timeout
    )
...
def subfn(
    ...
    **kwargs
    ...
    replacement string to be used."""
    return _compile(pattern, flags, ignore_unused, kwargs).subfn(
        format, string, count, pos, endpos, concurrent, timeout
    )
...
def split(
    ...
    **kwargs
    ...
    the list."""
    return _compile(pattern, flags, ignore_unused, kwargs).split(
...
def splititer(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, ignore_unused, kwargs).splititer(
        string, maxsplit, concurrent, timeout
    )
...
def findall(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, ignore_unused, kwargs).findall(
...
def finditer(
    ...
    **kwargs
    ...
    return _compile(pattern, flags, ignore_unused, kwargs).finditer(
